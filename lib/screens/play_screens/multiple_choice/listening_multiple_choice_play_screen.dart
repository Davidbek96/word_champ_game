...
// ########################
class ListeningMultipleChoicePlayScreen extends StatefulWidget {
  final List<QuestionModel> quizQestions;
  final Function(int, int)? onComplete;
  const ListeningMultipleChoicePlayScreen({
    super.key,
  ...
  @override
  State<ListeningMultipleChoicePlayScreen> createState() =>
      _ListeningMultipleChoicePlayScreenState();
}

class _ListeningMultipleChoicePlayScreenState
    extends State<ListeningMultipleChoicePlayScreen> {
                                  ...
                                  children: [
                                    ...
                                    if (getIconForOption(optionIndex) != null)
                                      Icon(
                                        ...
                                        color: getIconForOption(optionIndex) ==
                                                null
                                            ? Colors.blueGrey
                                            : Colors.white,
                                      ),
  ...
  // ####################
  void speakWord(String optionText) async {
    try {
      await flutterTts.speak(optionText);
    } catch (e) {
      throw Exception(e);
    }
  }
